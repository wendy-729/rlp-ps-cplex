...
from main_code.Dual_Problem import Main
from main_code.Dual_Problem_Pr import Main_Pr
from main_code.Dual_Problem_u_kt import Main_u_kt
    ...
    for actNumber in act:
        ...
        for group in range(1, 2):
            ...
            # for project in range(1, 2):
                ...
                filename = r'C:\Users\ASUS\Desktop\拉格朗日松弛模型\J'+ str(actNumber)+'\\'+'lagranger_lower_'+str(dtime)+'_'+'.txt'
                # 大修路径
                ...
                with open(filename, 'a', newline='') as f:
                    ...
                    # 松弛计算资源使用量约束
                    mf = Main(res, lftn + 1, activities, max_H)
